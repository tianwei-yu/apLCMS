patrick::with_parameters_test_that(
  "recover weaker signals test",
  {
    ...
    aligned <- load_aligned_features(file.path(testdata, "aligned", 'rt_cross_table.parquet'),
    ...
    recovered_actual <- list(extracted_features = lapply(recovered, function(x) x$this.f1),
